...
module GestionCine
  describe Film do
    ...
    describe "#<=>" do
      ...
      it_ "retourne -1 par rapport a un id plus grand" do
        (:tt2527336 <=> :tt3896198).must_equal( -1 )
      end

      it_ "retourne +1 par rapport a un id plus petit_" do
        (:tt3896198 <=> :tt3315342).must_equal 1
      end
    end
